...
function Ms(n, t) {
    if (t = t || new $(16), t === n) {
        let y;
        return y = n[1], n[1] = n[4], n[4] = y, y = n[2], n[2] = n[8], n[8] = y, y = n[3], n[3] = n[12], n[12] = y, y = n[6], n[6] = n[9], n[9] = y, y = n[7], n[7] = n[13], n[13] = y, y = n[11], n[11] = n[14], n[14] = y, t
    }
    const e = n[0 * 4 + 0],
        i = n[0 * 4 + 1],
        r = n[0 * 4 + 2],
        ...
        m = n[3 * 4 + 2],
        p = n[3 * 4 + 3];
    return t[0] = e, t[1] = o, t[2] = c, t[3] = g, t[4] = i, t[5] = a, t[6] = h, t[7] = _, t[8] = r, t[9] = l, t[10] = f, t[11] = m, t[12] = s, t[13] = u, t[14] = d, t[15] = p, t
}
...
function Ds(n, t, e) {
    ...
    const i = n[0],
        ...
        R = t[12 + 2],
        I = t[12 + 3];
    return e[0] = i * v + a * A + h * x + _ * E, e[1] = r * v + l * A + f * x + m * E, e[2] = s * v + u * A + d * x + p * E, e[3] = o * v + c * A + g * x + y * E, e[4] = i * T + a * w + h * b + _ * S, e[5] = r * T + l * w + f * b + m * S, e[6] = s * T + u * w + d * b + p * S, e[7] = o * T + c * w + g * b + y * S, e[8] = i * C + a * F + h * D + _ * O, e[9] = r * C + l * F + f * D + m * O, e[10] = s * C + u * F + d * D + p * O, e[11] = o * C + c * F + g * D + y * O, e[12] = i * k + a * z + h * R + _ * I, e[13] = r * k + l * z + f * R + m * I, e[14] = s * k + u * z + d * R + p * I, e[15] = o * k + c * z + g * R + y * I, e
}

function Os(n, t, e) {
    return e = e || Bn(), n !== e && (e[0] = n[0], e[1] = n[1], e[2] = n[2], e[3] = n[3], e[4] = n[4], e[5] = n[5], e[6] = n[6], e[7] = n[7], e[8] = n[8], e[9] = n[9], e[10] = n[10], e[11] = n[11]), e[12] = t[0], e[13] = t[1], e[14] = t[2], e[15] = 1, e
}
...
function Us(n, t, e, i) {
    return i = i || new $(16), Ot = Ot || Bt(), Ht = Ht || Bt(), Pt = Pt || Bt(), ei(Cs(n, t, Pt), Pt), ei(_n(e, Pt, Ot), Ot), ei(_n(Pt, Ot, Ht), Ht), i[0] = Ot[0], i[1] = Ot[1], i[2] = Ot[2], i[3] = 0, i[4] = Ht[0], i[5] = Ht[1], i[6] = Ht[2], i[7] = 0, i[8] = Pt[0], i[9] = Pt[1], i[10] = Pt[2], i[11] = 0, i[12] = n[0], i[13] = n[1], i[14] = n[2], i[15] = 1, i
}
...
function Vs(n, t, e) {
    ...
    const i = t[0],
        ...
        A = n[3 * 4 + 2],
        x = n[3 * 4 + 3];
    return n !== e && (e[0] = o, e[1] = a, e[2] = l, e[3] = u, e[4] = c, e[5] = h, e[6] = f, e[7] = d, e[8] = g, e[9] = _, e[10] = m, e[11] = p), e[12] = o * i + c * r + g * s + y, e[13] = a * i + h * r + _ * s + v, e[14] = l * i + f * r + m * s + A, e[15] = u * i + d * r + p * s + x, e
}
...
function Ks(n, t, e, i) {
    ...
    const l = r * r,
        ...
        R = n[10],
        I = n[11];
    return i[0] = g * T + _ * C + m * k, i[1] = g * w + _ * F + m * z, i[2] = g * b + _ * D + m * R, i[3] = g * S + _ * O + m * I, i[4] = p * T + y * C + v * k, i[5] = p * w + y * F + v * z, i[6] = p * b + y * D + v * R, i[7] = p * S + y * O + v * I, i[8] = A * T + x * C + E * k, i[9] = A * w + x * F + E * z, i[10] = A * b + x * D + E * R, i[11] = A * S + x * O + E * I, n !== i && (i[12] = n[12], i[13] = n[13], i[14] = n[14], i[15] = n[15]), i
}
...
{
    const n = $n;
    n[Fi] = Int8Array, n[be] = Uint8Array, n[Mi] = Int16Array, n[Di] = Uint16Array, n[Oi] = Int32Array, n[Ri] = Uint32Array, n[zi] = Float32Array, n[io] = Uint16Array, n[no] = Uint16Array, n[ro] = Uint16Array, n[so] = Uint16Array, n[oo] = Uint32Array, n[ao] = Uint32Array, n[lo] = Uint32Array, n[uo] = Uint32Array, n[co] = Uint32Array
}
...
function Po(n, t) {
    let e;
    if (So.test(n) ? e = 2 : Co.test(n) ? e = 4 : e = 3, t % e > 0) throw new Error(`Can not guess numComponents for attribute '${n}'. Tried ${e} but ${t} values is not evenly divisible by ${e}. You should specify it.`);
    return e
}
...
function Ro(n, t) {
    ...
    return Object.keys(t).forEach(function(i) {
        if (!qn(i)) {
            ...
            if (r.value) {
                if (!Array.isArray(r.value) && !_i(r.value)) throw new Error("array.value is not array or typedarray");
                e[s] = {
                    value: r.value
                }
            } else {
                let o;
                r.buffer && r.buffer instanceof WebGLBuffer ? o = Mo : typeof r == "number" || typeof r.data == "number" ? o = Do : o = Oo;
                const {
                    buffer: a,
                    type: l,
                    numValues: u,
...
function J(n, t, e, i) {
    ...
    return Bi(n) ? function(s) {
        let o, a;
        !s || Yn(n, s) ? (o = s, a = null) : (o = s.texture, a = s.sampler), n.uniform1i(i, e), n.activeTexture(ze + e), n.bindTexture(r, o), n.bindSampler(e, a)
    } : function(s) {
...
function tt(n, t, e, i, r) {
    ...
    return Bi(n) ? function(a) {
        n.uniform1iv(i, o), a.forEach(function(l, u) {
            ...
            let c, h;
            !l || Yn(n, l) ? (c = l, h = null) : (c = l.texture, h = l.sampler), n.bindSampler(e, h), n.bindTexture(s, c)
        })
    } : function(a) {
        n.uniform1iv(i, o), a.forEach(function(l, u) {
...
function Ke(n, t) {
    return function(e) {
        ...
        } else n.bindBuffer(He, e.buffer), n.enableVertexAttribArray(t), n.vertexAttribPointer(t, e.numComponents || e.size, e.type || Xe, e.normalize || !1, e.stride || 0, e.offset || 0), n.vertexAttribDivisor && n.vertexAttribDivisor(t, e.divisor || 0)
    }
}
...
function Vt(n, t) {
    return function(e) {
        ...
        else n.bindBuffer(He, e.buffer), n.enableVertexAttribArray(t), n.vertexAttribIPointer(t, e.numComponents || e.size, e.type || $i, e.stride || 0, e.offset || 0), n.vertexAttribDivisor && n.vertexAttribDivisor(t, e.divisor || 0)
    }
}
...
function Qe(n, t) {
    return function(e) {
        ...
        else n.bindBuffer(He, e.buffer), n.enableVertexAttribArray(t), n.vertexAttribIPointer(t, e.numComponents || e.size, e.type || Ui, e.stride || 0, e.offset || 0), n.vertexAttribDivisor && n.vertexAttribDivisor(t, e.divisor || 0)
    }
}
...
function Vi(n, t, e) {
    ...
    return function(s) {
        ...
        const o = s.size || s.numComponents || i,
            ...
            f = s.offset || 0,
            d = c / r;
        for (let g = 0; g < r; ++g) n.enableVertexAttribArray(t + g), n.vertexAttribPointer(t + g, a, l, h, c, f + d * g), n.vertexAttribDivisor && n.vertexAttribDivisor(t + g, s.divisor || 0)
    }
}
const H = {};
H[Xe] = {
    ...
    for (let a = 0; a < t.length; ++a) {
        ...
        if (typeof l == "string") {
            const u = Qn(l),
                c = u ? u.text : l;
            let h = n[Na[a]];
            u && u.type && (h = Va(n, u.type) || h), l = n.createShader(h), n.shaderSource(l, Ar(c).shaderSource), n.compileShader(l), n.attachShader(i, l)
        }
    }
    Object.entries(r).forEach(([a, l]) => n.bindAttribLocation(i, l, a));
    {
        let a = s;
        a && (a.attribs && (a = a.attribs), Array.isArray(a) || (a = Object.keys(a)), n.transformFeedbackVaryings(i, a, o || Yo))
    }
...
function Tr(n, t, e) {
    e.vertexArrayObject ? n.bindVertexArray(e.vertexArrayObject) : (nl(t.attribSetters || t, e.attribs), e.indices && n.bindBuffer(Lo, e.indices))
}
...
class ll {
    ...
    get(t) {
        return this.camera.mat = dn.translate(dn.perspective(this.camera.fov, t.canvas.width / t.canvas.height, this.camera.near, this.camera.far), [0, 0, this.camera.z]), this.camera
    }
}
...
class ml extends Et {
    ...
    _initInput() {
        ...
        const t = () => {
            ...
            i = p => {
                p.code === "Enter" && this.$input.blur(), p.code === "ArrowUp" && (p.preventDefault(), e(this._step * this._arrowKeyMultiplier(p))), p.code === "ArrowDown" && (p.preventDefault(), e(this._step * this._arrowKeyMultiplier(p) * -1))
            },
            r = p => {
        ...
        const h = 5,
            f = p => {
                o = p.clientX, a = l = p.clientY, s = !0, u = this.getValue(), c = 0, window.addEventListener("mousemove", d), window.addEventListener("mouseup", g)
            },
            d = p => {
                if (s) {
                    const y = p.clientX - o,
                        v = p.clientY - a;
                    Math.abs(v) > h ? (p.preventDefault(), this.$input.blur(), s = !1, this._setDraggingStyle(!0, "vertical")) : Math.abs(y) > h && g()
                }
                if (!s) {
                    const y = p.clientY - l;
                    c -= y * this._step * this._arrowKeyMultiplier(p), u + c > this._max ? c = this._max - u : u + c < this._min && (c = this._min - u), this._snapClampSetValue(u + c)
                }
                l = p.clientY
            },
            g = () => {
                this._setDraggingStyle(!1, "vertical"), this._callOnFinishChange(), window.removeEventListener("mousemove", d), window.removeEventListener("mouseup", g)
            },
            _ = () => {
        ...
        this.$input.addEventListener("input", t), this.$input.addEventListener("keydown", i), this.$input.addEventListener("wheel", r, {
            passive: !1
        }), this.$input.addEventListener("mousedown", f), this.$input.addEventListener("focus", _), this.$input.addEventListener("blur", m)
    }
    _initSlider() {
        ...
        const t = (p, y, v, A, x) => (p - y) / (v - y) * (x - A) + A,
            ...
            i = p => {
                this._setDraggingStyle(!0), e(p.clientX), window.addEventListener("mousemove", r), window.addEventListener("mouseup", s)
            },
            r = p => {
                e(p.clientX)
            },
        ...
        const u = p => {
            ...
            c = p => {
                p.touches.length > 1 || (this._hasScrollBar ? (a = p.touches[0].clientX, l = p.touches[0].clientY, o = !0) : u(p), window.addEventListener("touchmove", h, {
                    passive: !1
            ...
            h = p => {
                if (o) {
                    ...
                    Math.abs(y) > Math.abs(v) ? u(p) : (window.removeEventListener("touchmove", h), window.removeEventListener("touchend", f))
        ...
        const m = p => {
            ...
            this._snapClampSetValue(this.getValue() + v), this.$input.value = this.getValue(), clearTimeout(_), _ = setTimeout(d, g)
        };
...
class Gi {
    constructor({
        ...
        if (this.parent = t, this.root = t ? t.root : this, this.children = [], this.controllers = [], this.folders = [], this._closed = !1, this._hidden = !1, this.domElement = document.createElement("div"), this.domElement.classList.add("lil-gui"), this.$title = document.createElement("div"), this.$title.classList.add("title"), this.$title.setAttribute("role", "button"), this.$title.setAttribute("aria-expanded", !0), this.$title.setAttribute("tabindex", 0), this.$title.addEventListener("click", () => this.openAnimated(this._closed)), this.$title.addEventListener("keydown", u => {
                ...
                passive: !0
            }), this.$children = document.createElement("div"), this.$children.classList.add("children"), this.domElement.appendChild(this.$title), this.domElement.appendChild(this.$children), this.title(s), l && this.domElement.classList.add("allow-touch-styles"), this.parent) {
            this.parent.children.push(this), this.parent.folders.push(this), this.parent.$children.appendChild(this.domElement);
            return
        }
        this.domElement.classList.add("root"), !vn && a && (Al(xl), vn = !0), i ? i.appendChild(this.domElement) : e && (this.domElement.classList.add("autoPlace"), document.body.appendChild(this.domElement)), r && this.domElement.style.setProperty("--width", r + "px"), this._closeFolders = o, this.domElement.addEventListener("keydown", u => u.stopPropagation()), this.domElement.addEventListener("keyup", u => u.stopPropagation())
    }
    add(t, e, i, r, s) {
...
var ut = {
    ...
    Le = function() {
        var t = Lt.length,
            e = Lt.slice(0),
            i, r;
        for (yi = {}, Lt.length = 0, i = 0; i < t; i++) r = e[i], r && r._lazy && (r.render(r._lazy[0], r._lazy[1], !0)._lazy = 0)
    },
    Lr = function(t, e, i, r) {
        Lt.length && !Q && Le(), t.render(e, i, r || Q && e < 0 && (t._initted || t._startAt)), Lt.length && !Q && Le()
    },
    $r = function(t) {
        var e = parseFloat(t);
    ...
    An = function n(t, e) {
        for (var i in e) i !== "__proto__" && i !== "constructor" && i !== "prototype" && (t[i] = Ct(e[i]) ? n(t[i] || (t[i] = {}), e[i]) : e[i]);
        return t
    },
    $e = function(t, e) {
        var i = {},
    ...
    vi = function(t, e, i, r) {
        return t._startAt && (Q ? t._startAt.revert(De) : t.vars.immediateRender && !t.vars.autoRevert || t._startAt.render(e, !0, r))
    },
    Bl = function n(t) {
    ...
    ti = function(t, e) {
        var i = t._dp;
        return i && i.smoothChildTiming && t._ts && (t._start = q(i._time - (t._ts > 0 ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)), Je(t), i._dirty || Jt(i, t)), t
    },
    Vr = function(t, e) {
        var i;
        if ((e._time || e._initted && !e._dur) && (i = Ue(t.rawTime(), e), (!e._dur || Fe(0, e.totalDuration(), i) - e._tTime > L) && e.render(i, !0)), Jt(t, e)._dp && t._initted && t._time >= t._dur && t._ts) {
    ...
    wt = function(t, e, i, r) {
        return e.parent && Ut(e), e._start = q((Mt(i) ? i : i || t !== U ? pt(t, i, e) : t._time) + e._delay), e._end = q(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)), Nr(t, e, "_first", "_last", t._sort ? "_start" : 0), xi(e) || (t._recent = e), r || Vr(t, e), t._ts < 0 && ti(t, t._tTime), t
    },
    Yr = function(t, e) {
    ...
    Gr = function(t, e, i, r, s) {
        ...
        if (!i && t._pt && !Q && (t._dur && t.vars.lazy !== !1 || !t._dur && t.vars.lazy) && Ir !== lt.frame) return Lt.push(t), t._lazy = [s, r], 1
    },
    Ll = function n(t) {
        var e = t.parent;
    ...
    $l = function(t, e, i, r) {
        var s = t.ratio,
            o = e < 0 || !e && (!t._start && Ll(t) && !(!t._initted && xi(t)) || (t._ts < 0 || t._dp._ts < 0) && !xi(t)) ? 0 : 1,
            a = t._rDelay,
            l = 0,
            u, c, h;
        if (a && t._repeat && (l = Fe(0, t._tDur, e), c = ce(l, a), t._yoyo && c & 1 && (o = 1 - o), c !== ce(t._tTime, a) && (s = 1 - o, t.vars.repeatRefresh && t._initted && t.invalidate())), o !== s || Q || r || t._zTime === L || !e && t._zTime) {
            if (!t._initted && Gr(t, e, r, i, l)) return;
            for (h = t._zTime, t._zTime = e || (i ? L : 0), i || (i = e && !h), t.ratio = o, t._from && (o = 1 - o), t._time = 0, t._tTime = l, u = t._pt; u;) u.r(o, u.d), u = u._next;
            e < 0 && vi(t, e, i, !0), t._onUpdate && !i && vt(t, "onUpdate"), l && t._repeat && !i && t.parent && vt(t, "onRepeat"), (e >= t._tDur || e < 0) && t.ratio === o && (o && Ut(t, 1), !i && !Q && (vt(t, o ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()))
    ...
    he = function(t, e, i, r) {
        var s = t._repeat,
            o = q(e) || 0,
            a = t._tTime / t._tDur;
        return a && !r && (t._time *= o / t._dur), t._dur = o, t._tDur = s ? s < 0 ? 1e10 : q(o * (s + 1) + t._rDelay * s) : o, a > 0 && !r && ti(t, t._tTime = t._tDur * a), t.parent && Je(t), i || Jt(t.parent, t), t
    },
    wn = function(t) {
    ...
    xe = function(t, e, i) {
        ...
        if (r && (o.duration = e[1]), o.parent = i, t) {
            for (a = o, l = i; l && !("immediateRender" in a);) a = l.vars.defaults || {}, l = nt(l.vars.inherit) && l.parent;
    ...
    Ai = [].slice,
    Hr = function(t, e) {
        return t && Ct(t) && "length" in t && (!e && !t.length || t.length - 1 in t && Ct(t[0])) && !t.nodeType && t !== gt
    },
    Yl = function(t, e, i) {
    ...
    yt = function(t, e, i) {
        return G && !e && G.selector ? G.selector(t) : W(t) && !i && (mi || !fe()) ? Ai.call((e || qi).querySelectorAll(t), 0) : Z(t) ? Yl(t, i) : Hr(t) ? Ai.call(t, 0) : t ? [t] : []
    },
    bi = function(t) {
        ...
        return W(r) ? c = h = {
            ...
            function(f, d, g) {
                ...
                if (!m) {
                    ...
                    for (m = o[_] = [], p = l ? Math.min(b, _) * c - .5 : r % b, y = b === mt ? 0 : l ? _ * h / b - .5 : r / b | 0, T = 0, w = mt, E = 0; E < _; E++) v = E % b - p, A = y - (E / b | 0), m[E] = x = u ? Math.abs(u === "y" ? A : v) : Pr(v * v + A * A), x > T && (T = x), x < w && (w = x);
                    r === "random" && Xr(m), m.max = T - w, m.min = w, m.v = _ = (parseFloat(e.amount) || parseFloat(e.each) * (b > _ ? _ - 1 : u ? u === "y" ? _ / b : b : Math.max(b, _ / b)) || 0) * (r === "edges" ? -1 : 1), m.b = _ < 0 ? s - _ : s, m.u = K(e.amount || e.each) || 0, i = i && _ < 0 ? ns(i) : i
                }
    ...
    qr = function(t, e) {
        var i = Z(t),
            r, s;
        return !i && Ct(t) && (r = i = t.radius || mt, t.values ? (t = yt(t.values), (s = !Mt(t[0])) && (r *= r)) : t = wi(t.increment)), Yt(e, i ? V(t) ? function(o) {
            return s = t(o), Math.abs(s - o) <= r ? s : o
        } : function(o) {
            for (var a = parseFloat(s ? o.x : o), l = parseFloat(s ? o.y : 0), u = mt, c = 0, h = t.length, f, d; h--;) s ? (f = t[h].x - a, d = t[h].y - l, f = f * f + d * d) : f = Math.abs(t[h] - a), f < u && (u = f, c = h);
    ...
    Ee = function(t) {
        for (var e = 0, i = "", r, s, o, a; ~(r = t.indexOf("random(", e));) o = t.indexOf(")", r), a = t.charAt(r + 7) === "[", s = t.substr(r + 7, o - r - 7).match(a ? Dr : gi), i += t.substr(e, r - e) + jr(a ? s : +s[0], a ? 0 : +s[1], +s[2] || 1e-5), e = o + 1;
    ...
    vt = function(t, e, i) {
        var r = t.vars,
            ...
            a = t._ctx,
            l, u, c;
        if (s) return l = r[e + "Params"], u = r.callbackScope || t, i && Lt.length && Le(), a && (G = a), c = l ? s.apply(u, l) : s.call(u), G = o, c
    },
    me = function(t) {
    ...
    Jr = function(t) {
        ...
        if (fe(), t !== r) {
            if (at[e]) return;
            xt(r, xt($e(t, s), o)), ee(r.prototype, ee(s, $e(t, o))), at[r.prop = e] = r, t.targetTest && (Oe.push(r), Ki[e] = 1), e = (e === "css" ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin"
        }
    ...
    oi = function(t, e, i) {
        return t += t < 0 ? 1 : t > 1 ? -1 : 0, (t * 6 < 1 ? e + (i - e) * t * 6 : t < .5 ? i : t * 3 < 2 ? e + (i - e) * (2 / 3 - t) * 6 : e) * B + .5 | 0
    },
    ts = function(t, e, i) {
        ...
        if (!r) {
            if (t.substr(-1) === "," && (t = t.substr(0, t.length - 1)), ye[t]) r = ye[t];
                ...
                if (t.length < 6 && (s = t.charAt(1), o = t.charAt(2), a = t.charAt(3), t = "#" + s + s + o + o + a + a + (t.length === 5 ? t.charAt(4) + t.charAt(4) : "")), t.length === 9) return r = parseInt(t.substr(1, 6), 16), [r >> 16, r >> 8 & B, r & B, parseInt(t.substr(7), 16) / 255];
                t = parseInt(t.substr(1), 16), r = [t >> 16, t >> 8 & B, t & B]
            } else if (t.substr(0, 3) === "hsl") {
                if (r = g = t.match(gi), !e) l = +r[0] % 360 / 360, u = +r[1] / 100, c = +r[2] / 100, o = c <= .5 ? c * (u + 1) : c + u - c * u, s = c * 2 - o, r.length > 3 && (r[3] *= 1), r[0] = oi(l + 1 / 3, s, o), r[1] = oi(l, s, o), r[2] = oi(l - 1 / 3, s, o);
                else if (~t.indexOf("=")) return r = t.match(Fr), i && r.length < 4 && (r[3] = 1), r
            } else r = t.match(gi) || ye.transparent;
            r = r.map(Number)
        }
        return e && !g && (s = r[0] / B, o = r[1] / B, a = r[2] / B, h = Math.max(s, o, a), f = Math.min(s, o, a), c = (h + f) / 2, h === f ? l = u = 0 : (d = h - f, u = c > .5 ? d / (2 - h - f) : d / (h + f), l = h === s ? (o - a) / d + (o < a ? 6 : 0) : h === o ? (a - s) / d + 2 : (s - o) / d + 4, l *= 60), r[0] = ~~(l + .5), r[1] = ~~(u * 100 + .5), r[2] = ~~(c * 100 + .5)), i && r.length < 4 && (r[3] = 1), r
    },
    es = function(t) {
        var e = [],
            i = [],
    ...
    En = function(t, e, i) {
        ...
        if (s = s.map(function(f) {
            ...
            for (u = t.replace($t, "1").split(re), h = u.length - 1; a < h; a++) r += u[a] + (~l.indexOf(a) ? s.shift() || o + "0,0,0,0)" : (c.length ? c : s.length ? s : i).shift());
        if (!u)
    ...
    is = function(t) {
        var e = t.join(" "),
            i;
        if ($t.lastIndex = 0, $t.test(e)) return i = Kl.test(e), t[1] = En(t[1], i), t[0] = En(t[0], i, es(t[1])), !0
    },
    Se, lt = function() {
        var n = Date.now,
            t = 500,
            ...
            l, u, c, h, f, d, g = function _(m) {
                var p = n() - r,
                    y = m === !0,
                    v, A, x, E;
                if (p > t && (i += p - e), r += p, x = r - i, v = x - o, (v > 0 || y) && (E = ++h.frame, f = x - h.time * 1e3, h.time = x = x / 1e3, o += v + (v >= s ? 4 : s - v), A = 1), y || (l = u(_)), A)
        ...
        return h = {
            ...
            wake: function() {
                Or && (!mi && Wi() && (gt = mi = window, qi = gt.document || {}, ct.gsap = ot, (gt.gsapVersions || (gt.gsapVersions = [])).push(ot.version), Rr(Ie || gt.GreenSockGlobals || !gt.gsap && gt || {}), c = gt.requestAnimationFrame, Zr.forEach(Jr)), l && h.sleep(), u = c || function(m) {
    ...
    Zl = /["']/g,
    Jl = function(t) {
        for (var e = {}, i = t.substr(1, t.length - 3).split(":"), r = i[0], s = 1, o = i.length, a, l, u; s < o; s++) l = i[s], a = s !== o - 1 ? l.lastIndexOf(",") : l.length, u = l.substr(0, a), e[r] = isNaN(u) ? u.replace(Zl, "").trim() : +u, r = l.substr(a + 1).trim();
        return e
    },
    tu = function(t) {
        var e = t.indexOf("(") + 1,
    ...
    eu = function(t) {
        var e = (t + "").split("("),
            i = M[e[0]];
        return i && e.length > 1 && i.config ? i.config.apply(null, ~t.indexOf("{") ? [Jl(e[1])] : tu(t).split(",").map($r)) : M._CE && Ql.test(t) ? M._CE("", t) : i
    },
    ns = function(t) {
        return function(e) {
            return 1 - t(1 - e)
    ...
    rs = function n(t, e) {
        for (var i = t._first, r; i;) i instanceof it ? n(i, e) : i.vars.yoyoEase && (!i._yoyo || !i._repeat) && i._yoyo !== e && (i.timeline ? n(i.timeline, e) : (r = i._ease, i._ease = i._yEase, i._yEase = r, i._yoyo = e)), i = i._next
    },
    te = function(t, e) {
    ...
    ie = function(t, e, i, r) {
        ...
        return rt(t, function(a) {
            ...
            for (var l in s) M[o + (l === "easeIn" ? ".in" : l === "easeOut" ? ".out" : ".inOut")] = M[a + "." + l] = s[l]
        }), s
    },
    ss = function(t) {
        return function(e) {
...
(function(n, t) {
    var e = 1 / t,
        ...
        r = 2.5 * e,
        s = function(a) {
            return a < e ? n * a * a : a < i ? n * Math.pow(a - 1.5 / t, 2) + .75 : a < r ? n * (a -= 2.25 / t) * a + .9375 : n * Math.pow(a - 2.625 / t, 2) + .984375
        };
...
var os = function(t, e) {
        this.id = Cl++, t._gsap = this, this.target = t, this.harness = e, this.get = e ? e.get : Br, this.set = e ? e.getSetter : nn
    },
    _e = function() {
        function n(e) {
            this.vars = e, this._delay = +e.delay || 0, (this._repeat = e.repeat === 1 / 0 ? -2 : e.repeat || 0) && (this._rDelay = e.repeatDelay || 0, this._yoyo = !!e.yoyo || !!e.yoyoEase), this._ts = 1, he(this, +e.duration, 1, 1), this.data = e.data, G && (this._ctx = G, G.data.push(this)), Se || lt.wake()
        }
        var t = n.prototype;
        return t.delay = function(i) {
            ...
            if (s && s.smoothChildTiming && this._ts) {
                for (ti(this, i), !s._dp || s.parent || Vr(s, this); s && s.parent;) s.parent._time !== s._start + (s._ts >= 0 ? s._tTime / s._ts : (s.totalDuration() - s._tTime) / -s._ts) && s.totalTime(s._tTime, !0), s = s.parent;
            ...
            return (this._tTime !== i || !this._dur && !r || this._initted && Math.abs(this._zTime) === L || !i && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = i), Lr(this, i, r)), this
        }, t.time = function(i, r) {
            ...
            return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - i : i) + bn(this), r) : this.duration() ? Math.min(1, this._time / this._dur) : this.ratio
        }, t.iteration = function(i, r) {
            var s = this.duration() + this._rDelay;
            return arguments.length ? this.totalTime(this._time + (i - 1) * s, r) : this._repeat ? ce(this._tTime, s) + 1 : 1
            ...
            return this._rts = +i || 0, this._ts = this._ps || i === -L ? 0 : this._rts, this.totalTime(Fe(-Math.abs(this._delay), this._tDur, r), !0), Je(this), Il(this)
        }, t.paused = function(i) {
            ...
            var i = this.parent || this._dp,
                r = this._start,
                s;
            return !!(!i || this._ts && this._initted && i.isActive() && (s = i.rawTime(!0)) >= r && s < this.endTime(!0) - L)
            ...
            return new Promise(function(s) {
                var o = V(i) ? i : Ur,
                    a = function() {
                        var u = r.then;
                        r.then = null, V(o) && (o = o(r)) && (o.then || o === r) && (r.then = u), s(o), r.then = u
                    };
...
var it = function(n) {
    ...
    function t(i, r) {
        var s;
        return i === void 0 && (i = {}), s = n.call(this, i) || this, s.labels = {}, s.smoothChildTiming = !!i.smoothChildTiming, s.autoRemoveChildren = !!i.autoRemoveChildren, s._sort = nt(i.sortChildren), U && wt(i.parent || U, kt(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), i.scrollTrigger && Yr(kt(s), i.scrollTrigger), s
    }
    var e = t.prototype;
    return e.to = function(r, s, o) {
        ...
        return s.duration = 0, s.parent = this, ve(s).repeatDelay || (s.repeat = 0), s.immediateRender = !!s.immediateRender, new X(r, s, pt(this, o), 1), this
    }, e.call = function(r, s, o) {
        return wt(this, X.delayedCall(0, r, s), o)
    }, e.staggerTo = function(r, s, o, a, l, u, c) {
        return o.duration = s, o.stagger = o.stagger || a, o.onComplete = u, o.onCompleteParams = c, o.parent = this, new X(r, o, pt(this, l)), this
    }, e.staggerFrom = function(r, s, o, a, l, u, c) {
        return o.runBackwards = 1, ve(o).immediateRender = nt(o.immediateRender), this.staggerTo(r, s, o, a, l, u, c)
    }, e.staggerFromTo = function(r, s, o, a, l, u, c, h) {
        return a.startAt = o, ve(a).immediateRender = nt(a.immediateRender), this.staggerTo(r, s, a, l, u, c, h)
        ...
        if (this !== U && c > l && r >= 0 && (c = l), c !== this._tTime || o || h) {
            if (a !== this._time && u && (c += this._time - a, r += this._time - a), f = c, A = this._start, v = this._ts, p = !v, h && (u || (a = this._zTime), (r || !s) && (this._zTime = r)), this._repeat) {
                if (E = this._yoyo, m = u + this._rDelay, this._repeat < -1 && r < 0) return this.totalTime(m * 100 + r, s, o);
                if (f = q(c % m), c === l ? (_ = this._repeat, f = u) : (_ = ~~(c / m), _ && _ === c / m && (f = u, _--), f > u && (f = u)), x = ce(this._tTime, m), !a && this._tTime && x !== _ && this._tTime - x * m - this._dur <= 0 && (x = _), E && _ & 1 && (f = u - f, T = 1), _ !== x && !this._lock) {
                    var w = E && x & 1,
                        b = w === (E && _ & 1);
                    if (_ < x && (w = !w), a = w ? 0 : u, this._lock = 1, this.render(a || (T ? 0 : q(_ * m)), s, !u)._lock = 0, this._tTime = c, !s && this.parent && vt(this, "onRepeat"), this.vars.repeatRefresh && !T && (this.invalidate()._lock = 1), a && a !== this._time || p !== !this._ts || this.vars.onRepeat && !this.parent && !this._act) return this;
                    if (u = this._dur, l = this._tDur, b && (this._lock = 2, a = w ? u : -1e-4, this.render(a, !0), this.vars.repeatRefresh && !T && this.invalidate()), this._lock = 0, !this._ts && !p) return this;
                    rs(this, T)
                }
            }
            if (this._hasPause && !this._forcing && this._lock < 2 && (y = Ul(this, q(a), q(f)), y && (c -= f - (f = y._start))), this._tTime = c, this._time = f, this._act = !v, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = r, a = 0), !a && f && !s && !_ && (vt(this, "onStart"), this._tTime !== c)) return this;
            if (f >= a && r >= 0)
                for (d = this._first; d;) {
                    ...
                    for (var S = r < 0 ? r : f; d;) {
                        if (g = d._prev, (d._act || S <= d._end) && d._ts && y !== d) {
                            if (d.parent !== this) return this.render(r, s, o);
                            if (d.render(d._ts > 0 ? (S - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (S - d._start) * d._ts, s, o || Q && (d._initted || d._startAt)), f !== this._time || !this._ts && !p) {
            ...
            if (y && !s && (this.pause(), y.render(f >= a ? 0 : -L)._zTime = f >= a ? 1 : -1, this._ts)) return this._start = A, Je(this), this.render(r, s, o);
            this._onUpdate && !s && vt(this, "onUpdate", !0), (c === l && this._tTime >= this.totalDuration() || !c && a) && (A === this._start || Math.abs(v) !== Math.abs(this._ts)) && (this._lock || ((r || !u) && (c === l && this._ts > 0 || !c && this._ts < 0) && Ut(this, 1), !s && !(r < 0 && !a) && (c || a || !l) && (vt(this, c === l && r >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(c < l && this.timeScale() > 0) && this._prom())))
        }
        return this
    }, e.add = function(r, s) {
        var o = this;
        ...
        for (var l = [], u = this._first; u;) u._start >= a && (u instanceof X ? s && l.push(u) : (o && l.push(u), r && l.push.apply(l, u.getChildren(!0, s, o)))), u = u._next;
        return l
    }, e.getById = function(r) {
        for (var s = this.getChildren(1, 1, 1), o = s.length; o--;)
            if (s[o].vars.id === r) return s[o]
    }, e.remove = function(r) {
        return W(r) ? this.removeLabel(r) : V(r) ? this.killTweensOf(r) : (Ze(this, r), r === this._recent && (this._recent = this._last), Jt(this))
    }, e.totalTime = function(r, s) {
        return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = q(lt.time - (this._ts > 0 ? r / this._ts : (this.totalDuration() - r) / -this._ts))), n.prototype.totalTime.call(this, r, s), this._forcing = 0, this) : this._tTime
        ...
        for (var o = [], a = yt(r), l = this._first, u = Mt(s), c; l;) l instanceof X ? Ol(l._targets, a) && (u ? (!Rt || l._initted && l._ts) && l.globalTime(0) <= s && l.globalTime(l.totalDuration()) > s : !s || l.isActive()) && o.push(l) : (c = l.getTweensOf(a, s)).length && o.push.apply(o, c), l = l._next;
        return o
        ...
        var o = this,
            ...
            d, g = X.to(o, xt({
                ...
                time: a,
                overwrite: "auto",
                duration: s.duration || Math.abs((a - (u && "time" in u ? u.time : o._time)) / o.timeScale()) || L,
                onStart: function() {
                    if (o.pause(), !d) {
        ...
        if (o._dirty) {
            for (h = o.parent; a;) u = a._prev, a._dirty && a.totalDuration(), c = a._start, c > l && o._sort && a._ts && !o._lock ? (o._lock = 1, wt(o, a, c - a._delay, 1)._lock = 0) : l = c, c < 0 && a._ts && (s -= c, (!h && !o._dp || h && h.smoothChildTiming) && (o._start += c / o._ts, o._time -= c, o._tTime -= c), o.shiftChildren(-c, !1, -1 / 0), l = 0), a._end > s && a._ts && (s = a._end), a = u;
...
var iu = function(t, e, i, r, s, o, a) {
        var l = new st(this._pt, t, e, 0, 1, fs, null, s),
            ...
            c = 0,
            h, f, d, g, _, m, p, y;
        for (l.b = i, l.e = r, i += "", r += "", (p = ~r.indexOf("random(")) && (r = Ee(r)), o && (y = [i, r], o(y, t, e), i = y[0], r = y[1]), f = i.match(ri) || []; h = ri.exec(r);) g = h[0], _ = r.substring(u, h.index), d ? d = (d + 1) % 5 : _.substr(-5) === "rgba(" && (d = 1), g !== f[c++] && (m = parseFloat(f[c - 1]) || 0, l._pt = {
            _next: l._pt,
            p: _ || c === 1 ? _ : ",",
            s: m,
        ...
        return l.c = u < r.length ? r.substring(u, r.length) : "", l.fp = a, (Mr.test(r) || p) && (l.e = 0), this._pt = l, l
    },
    Ji = function(t, e, i, r, s, o, a, l, u, c) {
        V(r) && (r = r(s || 0, t, o));
        var h = t[e],
            f = i !== "get" ? i : V(h) ? u ? t[e.indexOf("set") || !V(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](u) : t[e]() : h,
            d = V(h) ? u ? au : cs : en,
            g;
        if (W(r) && (~r.indexOf("random(") && (r = Ee(r)), r.charAt(1) === "=" && (g = oe(f, r) + (K(f) || 0), (g || g === 0) && (r = g))), !c || f !== r || Ti) return !isNaN(f * r) && r !== "" ? (g = new st(this._pt, t, e, +f || 0, r - (f || 0), typeof h == "boolean" ? uu : hs, 0, d), u && (g.fp = u), a && g.modifier(a, this, t), this._pt = g) : (!h && !(e in t) && ji(e, r), iu.call(this, t, e, f, r, d, l || ut.stringFilter, u))
    },
    nu = function(t, e, i, r, s) {
        if (V(t) && (t = Ae(t, s, e, i, r)), !Ct(t) || t.style && t.nodeType || Z(t) || kr(t)) return W(t) ? Ae(t, s, e, i, r) : t;
        var o = {},
            a;
    ...
    as = function(t, e, i, r, s, o) {
        var a, l, u, c;
        if (at[t] && (a = new at[t]).init(s, a.rawVars ? e[t] : nu(e[t], r, s, o, i), i, r, o) !== !1 && (i._pt = l = new st(i._pt, s, t, 0, 1, a.render, a, 0, a.priority), i !== se))
    ...
    Rt, Ti, tn = function n(t, e, i) {
        ...
        if (E && (!g || !s) && (s = "none"), t._ease = te(s, ue.ease), t._yEase = d ? ns(te(d === !0 ? s : d, ue.ease)) : 0, d && t._yoyo && !t._repeat && (d = t._yEase, t._yEase = t._ease, t._ease = d), t._from = !E && !!r.runBackwards, !E || g && !r.stagger) {
            if (O = y[0] ? Zt(y[0]).harness : 0, I = O && r[O.prop], T = $e(r, Ki), p && (p._zTime < 0 && p.progress(1), e < 0 && f && a && !_ ? p.render(-1, !0) : p.revert(f && m ? De : Ml), p._lazy = 0), o) {
                if (Ut(t._startAt = X.set(y, xt({
                        ...
                        callbackScope: h,
                        stagger: 0
                    }, o))), t._startAt._dp = 0, t._startAt._sat = t, e < 0 && (Q || !a && !_) && t._startAt.revert(De), a && m && e <= 0 && i <= 0) {
                    e && (t._zTime = e);
                    return
                }
            } else if (f && m && !p) {
                if (e && (a = !1), b = xt({
                        ...
                        stagger: 0,
                        parent: v
                    }, T), I && (b[O.prop] = I), Ut(t._startAt = X.set(y, b)), t._startAt._dp = 0, t._startAt._sat = t, e < 0 && (Q ? t._startAt.revert(De) : t._startAt.render(-1, !0)), t._zTime = e, !a) n(t._startAt, L, L);
                else if (!e) return
            }
            for (t._pt = t._ptCache = 0, l = m && nt(l) || l && !m, w = 0; w < y.length; w++) {
                if (C = y[w], D = C._gsap || Zi(y)[w]._gsap, t._ptLookup[w] = z = {}, yi[D.id] && Lt.length && Le(), R = A === y ? w : A.indexOf(C), O && (k = new O).init(C, I || T, t, R, A) !== !1 && (t._pt = S = new st(t._pt, C, k.name, 0, 1, k.render, k, 0, k.priority), k._props.forEach(function(ft) {
                        z[ft] = S
                    }), k.priority && (F = 1)), !O || I)
                    for (b in T) at[b] && (k = as(b, T, t, R, C, A)) ? k.priority && (F = 1) : z[b] = S = Ji.call(t, C, b, "get", T[b], R, A, 0, r.stringFilter);
                t._op && t._op[w] && t.kill(C, t._op[w]), x && t._pt && (Rt = t, U.killTweensOf(C, z, t.globalTime(e)), ht = !t.parent, Rt = 0), t._pt && l && (yi[D.id] = 1)
            }
    ...
    ru = function(t, e, i, r, s, o, a) {
        ...
        for (f = l.length; f--;) c = l[f], u = c._pt || c, u.s = (r || r === 0) && !s ? r : u.s + (r || 0) + o * u.c, u.c = i - u.s, c.e && (c.e = Y(i) + K(c.e)), c.b && (c.b = u.s + K(c.b))
    },
    su = function(t, e) {
...
var X = function(n) {
    ...
    function t(i, r, s, o) {
        ...
        var l = a.vars,
            ...
            A, x, E, T, w, b, S, C;
        if (a._targets = v.length ? Zi(v) : Be("GSAP target " + i + " not found. https://greensock.com", !ut.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, g || f || Me(u) || Me(c)) {
            if (r = a.vars, A = a.timeline = new it({
                ...
                for (x = 0; x < T; x++) E = $e(r, us), E.stagger = 0, p && (E.yoyoEase = p), C && ee(E, C), b = v[x], E.duration = +Ae(u, kt(a), x, b, v), E.delay = (+Ae(c, kt(a), x, b, v) || 0) - a._delay, !f && T === 1 && E.delay && (a._delay = c = E.delay, a._start += c, E.delay = 0), A.to(b, E, S ? S(x, b, v) : 0), A._ease = M.none;
        ...
        return d === !0 && !Hi && (Rt = kt(a), U.killTweensOf(v), Rt = 0), wt(y, kt(a), s), r.reversed && a.reverse(), r.paused && a.paused(!0), (h || !u && !g && a._start === q(y._time) && nt(h) && Bl(kt(a)) && y.data !== "nested") && (a._tTime = -L, a.render(Math.max(0, -c) || 0)), m && Yr(kt(a), m), a
    }
    var e = t.prototype;
    return e.render = function(r, s, o) {
        var a = this._time,
            ...
            f, d, g, _, m, p, y, v, A;
        if (!u) $l(this, r, s, o);
        else if (h !== this._tTime || !r || o || !this._initted && this._tTime || this._startAt && this._zTime < 0 !== c) {
            if (f = h, v = this.timeline, this._repeat) {
                if (_ = u + this._rDelay, this._repeat < -1 && c) return this.totalTime(_ * 100 + r, s, o);
                if (f = q(h % _), h === l ? (g = this._repeat, f = u) : (g = ~~(h / _), g && g === h / _ && (f = u, g--), f > u && (f = u)), p = this._yoyo && g & 1, p && (A = this._yEase, f = u - f), m = ce(this._tTime, _), f === a && !o && this._initted) return this._tTime = h, this;
                g !== m && (v && this._yEase && rs(v, p), this.vars.repeatRefresh && !p && !this._lock && (this._lock = o = 1, this.render(q(_ * g), !0).invalidate()._lock = 0))
            }
            if (!this._initted) {
            ...
            if (this._tTime = h, this._time = f, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = y = (A || this._ease)(f / u), this._from && (this.ratio = y = 1 - y), f && !a && !s && !g && (vt(this, "onStart"), this._tTime !== h)) return this;
            for (d = this._pt; d;) d.r(y, d.d), d = d._next;
            v && v.render(r < 0 ? r : !f && p ? -L : v._dur * v._ease(f / this._dur), s, o) || this._startAt && (this._zTime = r), this._onUpdate && !s && (c && vi(this, r, s, o), vt(this, "onUpdate")), this._repeat && g !== m && this.vars.onRepeat && !s && this.parent && vt(this, "onRepeat"), (h === this._tDur || !h) && this._tTime === h && (c && !this._onUpdate && vi(this, r, !0, !0), (r || !u) && (h === this._tDur && this._ts > 0 || !h && this._ts < 0) && Ut(this, 1), !s && !(c && !a) && (h || a || p) && (vt(this, h === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(h < l && this.timeScale() > 0) && this._prom()))
        }
        return this
    }, e.targets = function() {
        ...
        var l = Math.min(this._dur, (this._dp._time - this._start) * this._ts),
            u;
        return this._initted || tn(this, l), u = this._ease(l / this._dur), ru(this, r, s, o, a, u, l) ? this.resetTo(r, s, o, a) : (ti(this, 0), this.parent || Nr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0))
    }, e.kill = function(r, s) {
        if (s === void 0 && (s = "all"), !r && (!s || s === "all")) return this._lazy = this._pt = 0, this.parent ? me(this) : this;
        if (this.timeline) {
            var o = this.timeline.totalDuration();
            return this.timeline.killTweensOf(r, s, Rt && Rt.vars.overwrite !== !0)._first || me(this), this.parent && o !== this.timeline.totalDuration() && he(this, this._dur * this.timeline._tDur / o, 0, 1), this
        }
        var a = this._targets,
            l = r ? yt(r) : a,
            u = this._ptLookup,
        ...
        for (h = this._op = this._op || [], s !== "all" && (W(s) && (_ = {}, rt(s, function(y) {
            ...
            if (~l.indexOf(a[p])) {
                ...
                for (_ in g) m = f && f[_], m && ((!("kill" in m.d) || m.d.kill(_) === !0) && Ze(this, m, "_pt"), delete f[_]), d !== "all" && (d[_] = 1)
...
var en = function(t, e, i) {
    ...
    st = function() {
        function n(e, i, r, s, o, a, l, u, c) {
            this.t = i, this.s = s, this.c = o, this.p = r, this.r = a || hs, this.d = l || this, this.set = u || en, this.pr = c || 0, this._next = e, e && (e._prev = this)
        }
        var t = n.prototype;
...
rt(Qi + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function(n) {
    return Ki[n] = 1
});
...
var de = [],
    ...
    ds = function() {
        ...
        return t.add = function(i, r, s) {
            ...
            var o = this,
                a = function() {
                    var u = G,
                        c = o.selector,
                        h;
                    return u && u !== o && u.data.push(o), s && (o.selector = bi(s)), G = o, h = r.apply(o, arguments), V(h) && o._r.push(h), G = u, o.selector = c, o.isReverted = !1, h
                };
            ...
            return this.data.forEach(function(r) {
                return r instanceof n ? i.push.apply(i, r.getTweens()) : r instanceof X && !(r.parent && r.parent.data === "nested") && i.push(r)
            }), i
        }, t.clear = function() {
    ...
    du = function() {
        ...
        return t.add = function(i, r, s) {
            ...
            for (u in i) u === "all" ? c = 1 : (l = gt.matchMedia(i[u]), l && (de.indexOf(o) < 0 && de.push(o), (a[u] = l.matches) && (c = 1), l.addListener ? l.addListener(Ei) : l.addEventListener("change", Ei)));
            return c && r(o), this
        }, t.revert = function(i) {
            this.kill(i || {})
        }, t.kill = function(i) {
    ...
    Ne = {
        ...
        getProperty: function(t, e, i, r) {
            ...
            var s = Zt(t || {}).get,
                o = i ? Ur : $r;
            return i === "native" && (i = ""), t && (e ? o((at[e] && at[e].get || s)(t, e, i, r)) : function(a, l, u) {
        ...
        exportRoot: function(t, e) {
            ...
            var i = new it(t),
                r, s;
            for (i.smoothChildTiming = nt(t.smoothChildTiming), U.remove(i), i._dp = 0, i._time = i._tTime = U._time, r = U._first; r;) s = r._next, (e || !(!r._dur && r instanceof X && r.vars.onComplete === r._targets[0])) && wt(i, r, r._start - r._delay), r = s;
            return wt(U, i, 0), i
        },
...
var pu = function(t, e) {
    ...
    gu = function(t, e) {
        var i = t._targets,
            r, s, o;
        for (r in e)
            for (s = i.length; s--;) o = t._ptLookup[s][r], o && (o = o.d) && (o._pt && (o = pu(o, r)), o && o.modifier && o.modifier(e[r], t, i[s], r))
    },
    ci = function(t, e) {
        return {
            name: t,
    ...
    ot = Ne.registerPlugin({
        ...
        init: function(t, e, i, r, s) {
            var o, a, l;
            this.tween = i;
            for (o in e) l = t.getAttribute(o) || "", a = this.add(t, "setAttribute", (l || 0) + "", e[o], r, s, 0, 0, o), a.op = o, a.b = l, this._props.push(o)
        },
        render: function(t, e) {
...
var Cn, zt, ae, sn, jt, Pn, on, mu = function() {
    ...
    ku = function n(t, e) {
        var i = this,
            ...
            s = r.style;
        if (t in Dt) {
            if (this.tfm = this.tfm || {}, t !== "transform") t = Tt[t] || t, ~t.indexOf(",") ? t.split(",").forEach(function(o) {
    ...
    Fu = function() {
        var t = this.props,
            ...
            r = e._gsap,
            s, o;
        for (s = 0; s < t.length; s += 3) t[s + 1] ? e[t[s]] = t[s + 2] : t[s + 2] ? i[t[s]] = t[s + 2] : i.removeProperty(t[s].substr(0, 2) === "--" ? t[s] : t[s].replace(an, "-$1").toLowerCase());
        if (this.tfm) {
            for (o in this.tfm) r[o] = this.tfm[o];
            r.svg && (r.renderTransform(), e.setAttribute("data-svg-origin", this.svgo || "")), s = on(), (!s || !s.isStart) && !i[N] && (ms(i), r.uncache = 1)
        }
    },
    ys = function(t, e) {
        var i = {
    ...
    vs, Ci = function(t, e) {
        var i = zt.createElementNS ? zt.createElementNS((e || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), t) : zt.createElement(t);
        return i.style ? i : zt.createElement(t)
    },
    St = function n(t, e, i) {
        var r = getComputedStyle(t);
        return r[e] || r.getPropertyValue(e.replace(an, "-$1").toLowerCase()) || r.getPropertyValue(e) || !i && n(t, pe(e) || e, 1) || ""
    },
    ...
    Pi = function() {
        mu() && window.document && (Cn = window, zt = Cn.document, ae = zt.documentElement, jt = Ci("div") || {
            style: {}
        }, Ci("div"), N = pe(N), At = N + "Origin", jt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", vs = !!pe("perspective"), on = ot.core.reverting, sn = 1)
    },
    hi = function n(t) {
        ...
        return i && (r ? i.insertBefore(this, r) : i.appendChild(this)), ae.removeChild(e), this.style.cssText = s, o
    },
    Mn = function(t, e) {
    ...
    xs = function(t) {
        ...
        return e && (e.width || e.height) || t.getBBox === hi || (e = hi.call(t, !0)), e && !e.width && !e.x && !e.y ? {
            x: +Mn(t, ["x", "cx", "x1"]) || 0,
            y: +Mn(t, ["y", "cy", "y1"]) || 0,
            width: 0,
            height: 0
    ...
    Ce = function(t, e) {
        if (e) {
            var i = t.style;
            e in Dt && e !== At && (e = N), i.removeProperty ? ((e.substr(0, 2) === "ms" || e.substr(0, 6) === "webkit") && (e = "-" + e), i.removeProperty(e.replace(an, "-$1").toLowerCase())) : i.removeAttribute(e)
        }
    },
    ...
    Nt = function n(t, e, i, r) {
        var s = parseFloat(i) || 0,
            ...
            d = r === "%",
            g, _, m, p;
        return r === o || !s || Dn[r] || Dn[o] ? s : (o !== "px" && !f && (s = n(t, e, i, "px")), p = t.getCTM && As(t), (d || o === "%") && (Dt[e] || ~e.indexOf("adius")) ? (g = p ? t.getBBox()[l ? "width" : "height"] : t[c], Y(d ? s / g * h : s / 100 * g)) : (a[l ? "width" : "height"] = h + (f ? o : r), _ = ~e.indexOf("adius") || r === "em" && t.appendChild && !u ? t : t.parentNode, p && (_ = (t.ownerSVGElement || {}).parentNode), (!_ || _ === zt || !_.appendChild) && (_ = zt.body), m = _._gsap, m && d && m.width && l && m.time === lt.time && !m.uncache ? Y(s / m.width * h) : ((d || o === "%") && !Mu[St(_, "display")] && (a.position = St(t, "position")), _ === t && (a.position = "static"), _.appendChild(jt), g = jt[c], _.removeChild(jt), a.position = "absolute", l && d && (m = Zt(_), m.time = lt.time, m.width = _[c]), Y(f ? g * s / h : g && s ? h / g * s : 0))))
    },
    Ft = function(t, e, i, r) {
        var s;
        return sn || Pi(), e in Tt && e !== "transform" && (e = Tt[e], ~e.indexOf(",") && (e = e.split(",")[0])), Dt[e] && e !== "transform" ? (s = ke(t, r), s = e !== "transformOrigin" ? s[e] : s.svg ? s.origin : Ye(St(t, At)) + " " + s.zOrigin + "px") : (s = t.style[e], (!s || s === "auto" || r || ~(s + "").indexOf("calc(")) && (s = Ve[e] && Ve[e](t, e, i) || St(t, e) || Br(t, e) || (e === "opacity" ? 1 : 0))), i && !~(s + "").trim().indexOf(" ") ? Nt(t, e, s, i) + i : s
    },
    Du = function(t, e, i, r) {
        if (!i || i === "none") {
            var s = pe(e, t, 1),
        ...
        if (a.b = i, a.e = r, i += "", r += "", r === "auto" && (t.style[e] = r, r = St(t, e) || r, t.style[e] = i), c = [i, r], is(c), i = c[0], r = c[1], f = i.match(re) || [], x = r.match(re) || [], x.length) {
            for (; h = re.exec(r);) m = h[0], y = r.substring(l, h.index), g ? g = (g + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (g = 1), m !== (_ = f[u++] || "") && (d = parseFloat(_) || 0, A = _.substr((d + "").length), m.charAt(1) === "=" && (m = oe(d, m) + A), p = parseFloat(m), v = m.substr((p + "").length), l = re.lastIndex - v.length, v || (v = v || ut.units[e] || A, l === r.length && (r += v, a.e += v)), A !== v && (d = Nt(t, e, _, v) || 0), a._pt = {
                _next: a._pt,
                p: y || u === 1 ? y : ",",
                s: d,
                c: p - d,
    ...
    Ou = function(t) {
        var e = t.split(" "),
            i = e[0],
            r = e[1] || "50%";
        return (i === "top" || i === "bottom" || r === "left" || r === "right") && (t = i, i = r, r = t), e[0] = On[i] || i, e[1] = On[r] || r, e.join(" ")
    },
    Ru = function(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if (s === "all" || s === !0) r.cssText = "", l = 1;
                ...
                for (s = s.split(","), u = s.length; --u > -1;) a = s[u], Dt[a] && (l = 1, a = a === "transformOrigin" ? At : N), Ce(i, a);
    ...
    ln = function(t, e) {
        var i = t._gsap || Zt(t),
            ...
            s = Rn(t),
            o, a, l, u;
        return i.svg && t.getAttribute("transform") ? (l = t.transform.baseVal.consolidate().matrix, s = [l.a, l.b, l.c, l.d, l.e, l.f], s.join(",") === "1,0,0,1,0,0" ? Pe : s) : (s === Pe && !t.offsetParent && t !== ae && !i.svg && (l = r.display, r.display = "block", o = t.parentNode, (!o || !t.offsetParent) && (u = 1, a = t.nextElementSibling, ae.appendChild(t)), s = Rn(t), l ? r.display = l : Ce(t, "display"), u && (a ? o.insertBefore(t, a) : o ? o.appendChild(t) : ae.removeChild(t))), e && s.length > 6 ? [s[0], s[1], s[4], s[5], s[12], s[13]] : s)
    },
    ...
    Ts = function(t, e) {
        ...
        if (v && (h !== Xt || c !== Xt)) {
            var E = parseFloat(c) * le,
                ...
                w = Math.cos(E),
                b;
            E = parseFloat(h) * le, b = Math.cos(E), o = fi(y, o, T * b * -v), a = fi(y, a, -Math.sin(E) * -v), l = fi(y, l, w * b * -v + v)
        }
        m !== ge && (A += "perspective(" + m + Wt), (r || s) && (A += "translate(" + r + "%, " + s + "%) "), (x || o !== ge || a !== ge || l !== ge) && (A += l !== ge || x ? "translate3d(" + o + ", " + a + ", " + l + ") " : "translate(" + o + ", " + a + Wt), u !== Xt && (A += "rotate(" + u + Wt), c !== Xt && (A += "rotateY(" + c + Wt), h !== Xt && (A += "rotateX(" + h + Wt), (f !== Xt || d !== Xt) && (A += "skew(" + f + ", " + d + Wt), (g !== 1 || _ !== 1) && (A += "scale(" + g + ", " + _ + Wt), y.style[N] = A || "translate(0, 0)"
    },
    Iu = function(t, e) {
        var i = e || this,
            r = i.xPercent,
    ...
    Bu = function(t, e, i, r, s) {
        var o = 360,
            ...
            c = r + u + "deg",
            h, f;
        return a && (h = s.split("_")[1], h === "short" && (u %= o, u !== u % (o / 2) && (u += u < 0 ? o : -o)), h === "cw" && u < 0 ? u = (u + o * kn) % o - ~~(u / o) * o : h === "ccw" && u > 0 && (u = (u - o * kn) % o - ~~(u / o) * o)), t._pt = f = new st(t._pt, e, i, r, u, xu), f.e = c, f.u = "deg", t._props.push(i), f
    },
    zn = function(t, e) {
        for (var i in e) t[i] = e[i];
        return t
    ...
    Lu = function(t, e, i) {
        var r = zn({}, i._gsap),
            ...
            o = i.style,
            a, l, u, c, h, f, d, g;
        r.svg ? (u = i.getAttribute("transform"), i.setAttribute("transform", ""), o[N] = e, a = ke(i, 1), Ce(i, N), i.setAttribute("transform", u)) : (u = getComputedStyle(i)[N], o[N] = e, a = ke(i, 1), o[N] = u);
        for (l in Dt) u = r[l], c = a[l], u !== c && s.indexOf(l) < 0 && (d = K(u), g = K(c), h = d !== g ? Nt(i, l, u, g) : parseFloat(u), f = parseFloat(c), t._pt = new st(t._pt, a, l, h, f - h, Si), t._pt.u = g || 0, t._props.push(l));
        zn(a, r)
    };
...
var Es = {
    ...
    init: function(t, e, i, r, s) {
        ...
        for (_ in e)
            if (_ !== "autoRound" && (c = e[_], !(at[_] && as(_, e, i, r, t, s)))) {
                if (d = typeof c, g = Ve[_], d === "function" && (c = c.call(i, r, t, s), d = typeof c), d === "string" && ~c.indexOf("random(") && (c = Ee(c)), g) g(this, t, _, c, i) && (T = 1);
                else if (_.substr(0, 2) === "--") u = (getComputedStyle(t).getPropertyValue(_) + "").trim(), c += "", $t.lastIndex = 0, $t.test(u) || (m = K(u), p = K(c)), p ? m !== p && (u = Nt(t, _, u, p) + p) : m && (c += m), this.add(a, "setProperty", u, c, r, s, 0, 0, _), o.push(_), w.push(_, 0, a[_]);
                else if (d !== "undefined") {
                    if (l && _ in l ? (u = typeof l[_] == "function" ? l[_].call(i, r, t, s) : l[_], W(u) && ~u.indexOf("random(") && (u = Ee(u)), K(u + "") || (u += ut.units[_] || K(Ft(t, _)) || ""), (u + "").charAt(1) === "=" && (u = Ft(t, _))) : u = Ft(t, _), f = parseFloat(u), y = d === "string" && c.charAt(1) === "=" && c.substr(0, 2), y && (c = c.substr(2)), h = parseFloat(c), _ in Tt && (_ === "autoAlpha" && (f === 1 && Ft(t, "visibility") === "hidden" && h && (f = 0), w.push("visibility", 0, a.visibility), It(this, a, "visibility", f ? "inherit" : "hidden", h ? "inherit" : "hidden", !h)), _ !== "scale" && _ !== "transform" && (_ = Tt[_], ~_.indexOf(",") && (_ = _.split(",")[0]))), v = _ in Dt, v) {
                        if (this.styles.save(_), A || (x = t._gsap, x.renderTransform && !e.parseTransform || ke(t, e.parseTransform), E = e.smoothOrigin !== !1 && x.smooth, A = this._pt = new st(this._pt, a, N, 0, 1, x.renderTransform, x, 0, -1), A.dep = 1), _ === "scale") this._pt = new st(this._pt, x, "scaleY", x.scaleY, (y ? oe(x.scaleY, y + h) : h) - x.scaleY || 0, Si), this._pt.u = 0, o.push("scaleY", _), _ += "X";
                        else if (_ === "transformOrigin") {
                            w.push(At, 0, a[At]), c = Ou(c), x.svg ? ki(t, c, 0, E, 0, this) : (p = parseFloat(c.split(" ")[2]) || 0, p !== x.zOrigin && It(this, x, "zOrigin", x.zOrigin, p), It(this, a, _, Ye(u), Ye(c)));
                            continue
                        } else if (_ === "svgOrigin") {
                            ki(t, c, 1, E, 0, this);
                            continue
                    ...
                    if (v || (h || h === 0) && (f || f === 0) && !vu.test(c) && _ in a) m = (u + "").substr((f + "").length), h || (h = 0), p = K(c) || (_ in ut.units ? ut.units[_] : m), m !== p && (f = Nt(t, _, u, p)), this._pt = new st(this._pt, v ? x : a, _, f, (y ? oe(f, y + h) : h) - f, !v && (p === "px" || _ === "zIndex") && e.autoRound !== !1 ? bu : Si), this._pt.u = p || 0, m !== p && p !== "%" && (this._pt.b = u, this._pt.r = Au);
    ...
    getSetter: function(t, e, i) {
        var r = Tt[e];
        return r && r.indexOf(",") < 0 && (e = r), e in Dt && e !== At && (t._gsap.x || Ft(t, "x")) ? i && Pn === i ? e === "scale" ? Su : Eu : (Pn = i || {}) && (e === "scale" ? Cu : Pu) : t.style && !Xi(t.style[e]) ? wu : ~e.indexOf("-") ? Tu : nn(t, e)
    },
    core: {
        _removeProperty: Ce,
        _getMatrix: ln
...
class $u {
    constructor(t, e = {}) {
        this.gl = t, this.data = e, this.shaders = El, this.programInfo = Er(this.gl, this.shaders), this.data.test && this.initGui(), this.a = {
            mode: 1,
            swap: 0
    ...
    render(t, {
        ...
        this.gl.useProgram(this.programInfo.program), Tr(this.gl, this.programInfo, this.bufferInfo), Qt(this.programInfo, {
...
class Uu {
    ...
    computeParams() {
        const t = document.querySelector('[data-gradient="wrapper"]'),
            ...
            i = [parseFloat(t.dataset.red2) || 0, parseFloat(t.dataset.green2) || 0, parseFloat(t.dataset.blue2) || 0];
        this.params = {
...
class Gu {
    constructor(t, e = {}) {
        this.gl = t, this.data = e, this.shaders = Yu, this.programInfo = Er(this.gl, this.shaders), this.gl.useProgram(this.programInfo.program), this.setBuffAtt(), this.setUniforms()
    }
    setBuffAtt() {
        const t = {
            position: [-1, -1, 0, 1, -1, 0, -1, 1, 0, -1, 1, 0, 1, -1, 0, 1, 1, 0]
...
class Xu {
    constructor(canvasSelector) {
        this.canvas = document.querySelector(canvasSelector), this.gl = this.canvas.getContext("webgl"), this.gl.clearColor(.04, .04, .04, 1), this.gl.vp = {
            dpr: Math.min(window.devicePixelRatio, 2)
        }, this.camera = new ll(this.gl), this.gl.camera = this.camera.get(this.gl), new ResizeObserver(t => this.resize(t[0].contentRect)).observe(this.canvas), this.resize(), this.scroll = new al(this.gl), this.time = 0, this.create(), this.render(), this.resize()
    }
    create() {
        this.post = new Hu(this.gl), this.post.isActive = !1, this.scene = new Uu(this.gl), window.dispatchEvent(new Event("gradientReady"))
    }
    render() {
...
// Criar instâncias para cada elemento desejado
const xu1 = new Xu(".c1");
const xu2 = new Xu(".c2");
const xu3 = new Xu(".c3");

// Criar uma lista de instâncias para fácil iteração
const xuInstances = [xu1, xu2, xu3];
